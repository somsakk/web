...
clientSocket.connect((serverName,serverPort)) # connect to the server app

# Just want to see the socket info
print('The client is (ip, port no.): ', clientSocket.getsockname())

sentence = input('Input lowercase sentence:')

clientSocket.send(sentence.encode()) # convert string into bytes
